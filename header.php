...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri() ?>/css/app.css?<?php echo time(); ?>"> -->
	<?php wp_enqueue_style( 'uniquestylesheetid', get_template_directory_uri() . '/css/app.css' );  ?>
