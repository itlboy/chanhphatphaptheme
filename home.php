			...
			<div class="block-wrapper notification-block col-xs-12">
				...
				<div class="social-share-wrapper col-xs-12">
					...
					<div class="list-social-btn col-xs-12">
						<div class="social-btn-item icon-009"><a href="#"></a></div>
						<div class="social-btn-item icon-010"><a href="#"></a></div>
						<div class="social-btn-item icon-014"><a href="#"></a></div>
						<div class="social-btn-item icon-007"><a href="#"></a></div>
					</div>
