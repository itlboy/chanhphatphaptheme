	...
	<div class="left-content col-xs-8">
		<div class="block-wrapper col-xs-12">
			<div class="title-block-wrapper col-xs-12">
				<div class="title-block">Tìm kiếm từ khoá : <?php if(isset($_REQUEST['s'])){echo $_REQUEST['s']; } ?> </div>
		...
		<div class="block-wrapper col-xs-12">
			...
			if ( have_posts() ) : ?>
				...
				<?php endwhile; 
					...
					<p>Xin lỗi, không có bài viết nào có từ khóa "<?php if(isset($_REQUEST['s'])){echo $_REQUEST['s']; } ?>"</p>
